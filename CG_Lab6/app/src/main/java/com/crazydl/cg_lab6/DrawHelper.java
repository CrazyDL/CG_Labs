...
class DrawHelper {
    ...
    private final String fragmentShaderCode =
            "precision mediump float;"+
                    ...
                    "float specular = k_specular * pow( max(dot(lookvector,reflectvector),0.0), 6.0 );"+
    ...
    DrawHelper(int program) {
        ...
        mCameraPositionHandle = GLES20.glGetUniformLocation(mProgram, "u_camera");
    }
    ...
    void draw(float[] trianglesCoords, float[] normalCoords) {
        ...
        GLES20.glUniform3f(mLightPositionHandle, MyGLRenderer.lightX, MyGLRenderer.lightY, MyGLRenderer.lightZ);

        GLES20.glUniform3f(mCameraPositionHandle, 0, 0, 4);
